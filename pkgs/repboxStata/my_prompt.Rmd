...
Another package calls replace.files.and.paths.with.ph with a tab argument generated by repbox.re.cmdlines.to.tab. Yet unlike repbox.do.table repbox.re.cmdlines.to.tab does not generate the cmd2 column that is e.g. used to determine the "excel" in import excel commands. Can you safely adapt repbox.re.cmdlines.to.tab so that it also generates the cmd2 field? Does this make sense? Or do I understand something wrong here... Explain and provide an implementation if sensible.
