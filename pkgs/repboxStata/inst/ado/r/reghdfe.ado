...
*Modification by Sebastian Kranz (for maintaining backwards compatibility)
*based on an email from Sergei Correia
program reghdfe
  cap noi reghdfe_v6 `0'
  if c(rc)==132 {
      di as error "warning: likely using an older version of reghdfe; attempting v3"
    cap noi reghdfe_v6 `0' version(3)
  }
end


program define reghdfe_v6
