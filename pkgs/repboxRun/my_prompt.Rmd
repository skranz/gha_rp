...
# FILE: /home/rstudio/repbox/repboxGithub/R/copy_r_pkg.R
```
...
```
# END OF FILE: /home/rstudio/repbox/repboxGithub/R/copy_r_pkg.R
...
The Github container throws the following error:

Running raw Stata reproduction
Error in repboxRun:::rb_run_stata_reproduction_raw(rb = rb, overwrite = isTRUE(cfg$overwrite),  : 
  unused argument (capture_scalar_info = isTRUE(cfg$capture_scalar_info))
Execution halted
Error: Process completed with exit code 1.

Likely reason: an outdated repboxGithub package version in the container.

But actually I would prefer that the code run on GHA does not need repboxGithub as installation fails earlier anyway in container. Where is the repboxGithub dependence in the code run in the container. Can we move that function to repboxRun or perhaps don't need the function call at all?
