...
When running run_minimal_stata_repro.R on Github Actions it fails,
because it needs packages repboxEJD and repboxExplore.

Actually, my pipeline should allow the minimum Stata reproduction with
only the packages repboxRun, repboxStata, repboxUtils and repboxDB
plus possible utility packages like stringtools, restorepoint.

Can you check where in the pipeline repboxEJD and repboxExplore are required?

You may also look up other packages on Github user repboxr.
